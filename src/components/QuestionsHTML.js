...
import { questionHTML } from "../data/Preguntas";
import Character from "../assets/caracters.png";
import "../styles/Questios.css";

export default class QuestionsHTML extends Component {
  constructor() {
    super();
    this.state = {
      numberQuestion: 0,
  ...
  componentDidMount() {
    ...
    const currentVidas = questionHTML[this.state.vidas];
    this.setState({
      question: {
    ...
    return (
      <form className="container" onSubmit={this.handleSubmit}>
        ...
        <h2 style={{ textAlign: "center" }}>
          Pregunta
          {this.state.numberQuestion} de {questionHTML.length}
        </h2>
      </form>
    );
  }
