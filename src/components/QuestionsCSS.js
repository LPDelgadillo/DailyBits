...
import { questionCSS } from "../data/Preguntas";
import Character from "../assets/caracters.png";
import "../styles/Questios.css";

export default class QuestionsCSS extends Component {
  constructor() {
    super();
    this.state = {
      numberQuestion: 0,
  ...
  componentDidMount() {
    ...
    const currentVidas = questionCSS[this.state.vidas];
    this.setState({
      question: {
    ...
    return (
      <form className="container" onSubmit={this.handleSubmit}>
        ...
        <h2 style={{ textAlign: "center" }}>
          Pregunta
          {this.state.numberQuestion} de {questionCSS.length}
        </h2>
      </form>
    );
  }
