...
import {  questionUX } from "../data/Preguntas";
import Character from "../assets/caracters.png";
import "../styles/Questios.css";

export default class QuestionsUX extends Component {
  constructor() {
    super();
    this.state = {
      numberQuestion: 0,
  ...
  componentDidMount() {
    ...
    const currentVidas = questionUX[this.state.vidas];
    this.setState({
      question: {
  ...
  render() {
    ...
    return (
      <form className="container" onSubmit={this.handleSubmit}>
        ...
        <h2 style={{ textAlign: "center" }}>Pregunta 
          {this.state.numberQuestion} de {questionUX.length}
        </h2>
      </form>
    );
  }
